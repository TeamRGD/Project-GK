...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[8] = float4(0.718750,0.709487,0.600371,1.000000);//(Unknown)
	Material.PreshaderBuffer[9] = float4(0.000000,0.000000,0.719618,0.123810);//(Unknown)
	Material.PreshaderBuffer[10] = float4(1.000000,0.718750,0.709487,0.600371);//(Unknown)
