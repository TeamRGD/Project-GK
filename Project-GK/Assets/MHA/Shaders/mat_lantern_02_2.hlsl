...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[4] = float4(1.000000,0.356177,0.000000,1.000000);//(Unknown)
	Material.PreshaderBuffer[5] = float4(0.000000,0.000000,106.470329,0.123810);//(Unknown)
	Material.PreshaderBuffer[6] = float4(1.000000,1.000000,0.356177,0.000000);//(Unknown)
