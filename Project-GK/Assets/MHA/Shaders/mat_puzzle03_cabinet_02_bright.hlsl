...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[5] = float4(0.000000,0.000000,0.000000,-0.030857);//(Unknown)
	Material.PreshaderBuffer[6] = float4(-0.589333,1.000000,1.000000,1.000000);//(Unknown)
	...
	Material.PreshaderBuffer[9] = float4(0.000000,0.000000,4.085531,0.374477);//(Unknown)
	Material.PreshaderBuffer[10] = float4(0.454256,1.000000,1.000000,1.000000);//(Unknown)
	Material.PreshaderBuffer[11] = float4(1.000000,1.000000,1.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[12] = float4(0.133333,0.000000,1.000000,0.000000);//(Unknown)
