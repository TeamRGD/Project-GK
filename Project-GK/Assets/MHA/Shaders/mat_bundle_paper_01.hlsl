...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[8] = float4(0.729167,0.721899,0.641819,1.000000);//(Unknown)
	Material.PreshaderBuffer[9] = float4(0.000000,0.000000,0.807346,0.123810);//(Unknown)
	Material.PreshaderBuffer[10] = float4(1.000000,0.729167,0.721899,0.641819);//(Unknown)
