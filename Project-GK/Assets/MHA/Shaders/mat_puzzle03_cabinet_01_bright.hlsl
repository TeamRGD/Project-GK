...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[5] = float4(0.000000,0.000000,0.000000,0.625143);//(Unknown)
	Material.PreshaderBuffer[6] = float4(0.897564,1.000000,1.000000,1.000000);//(Unknown)
	...
	Material.PreshaderBuffer[9] = float4(-0.000000,-0.000000,3.185664,0.257143);//(Unknown)
	Material.PreshaderBuffer[10] = float4(0.423515,1.000000,1.000000,1.000000);//(Unknown)
