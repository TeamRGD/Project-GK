Shader "Unreal/mat_puzzle03_cabinet_02_bright"
{
    Properties
    {
		...
		Material_Texture2D_0( "NormalHeight", 2D ) = "white" {}
		Material_Texture2D_1( "Emissive", 2D ) = "white" {}
		Material_Texture2D_2( "Albedo Texture", 2D ) = "white" {}
		Material_Texture2D_3( "Masks (Occ,Rough,Met)", 2D ) = "white" {}
		Material_Texture2D_4( "SSS", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "mat_puzzle03_cabinet_02_bright.hlsl"
