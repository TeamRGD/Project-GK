...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[5] = float4(0.000000,0.000000,0.000000,-0.382857);//(Unknown)
	...
	Material.PreshaderBuffer[9] = float4(-0.000000,-0.000000,0.228759,-0.420190);//(Unknown)
	Material.PreshaderBuffer[10] = float4(0.610837,1.000000,1.000000,1.000000);//(Unknown)
