...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[8] = float4(0.395833,0.388213,0.343029,1.000000);//(Unknown)
	Material.PreshaderBuffer[9] = float4(0.000000,0.000000,1.000000,0.123810);//(Unknown)
	Material.PreshaderBuffer[10] = float4(1.000000,0.395833,0.388213,0.343029);//(Unknown)
