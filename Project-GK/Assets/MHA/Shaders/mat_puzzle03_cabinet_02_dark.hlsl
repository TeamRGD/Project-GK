...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[9] = float4(0.000000,0.000000,0.964837,-0.238857);//(Unknown)
	Material.PreshaderBuffer[10] = float4(0.322781,1.000000,1.000000,1.000000);//(Unknown)
