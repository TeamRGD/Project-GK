...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[7] = float4(0.000000,0.000000,1.000000,0.123810);//(Unknown)
	...
	Material.PreshaderBuffer[10] = float4(1.100000,1.000000,0.000000,0.000000);//(Unknown)
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat3 Local19 = (Local17.rgb * ((MaterialFloat3)Material.PreshaderBuffer[4].x));
	MaterialFloat3 Local20 = lerp(Local19,Material.PreshaderBuffer[5].xyz,Material.PreshaderBuffer[4].y);
	MaterialFloat Local21 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local6), 0);
	MaterialFloat4 Local22 = ProcessMaterialLinearColorTextureLookup(Texture2DSampleBias(Material_Texture2D_2,samplerMaterial_Texture2D_2,DERIV_BASE_VALUE(Local6),View.MaterialTextureMipBias));
	MaterialFloat Local23 = MaterialStoreTexSample(Parameters, Local22, 0);
	MaterialFloat3 Local24 = (Local22.rgb * ((MaterialFloat3)Material.PreshaderBuffer[7].z));
	MaterialFloat Local25 = dot(Local24,MaterialFloat3(0.30000001,0.58999997,0.11000000));
	MaterialFloat3 Local26 = lerp(Local24,((MaterialFloat3)Local25),Material.PreshaderBuffer[7].w);
	MaterialFloat3 Local27 = (Local26 * ((MaterialFloat3)Material.PreshaderBuffer[8].x));
	MaterialFloat3 Local28 = RotateAboutAxis(MaterialFloat4(normalize(MaterialFloat3(1.00000000,1.00000000,1.00000000)),Material.PreshaderBuffer[7].y),((MaterialFloat3)0.00000000),Local27);
	MaterialFloat3 Local29 = (Local28 + Local27);
	MaterialFloat3 Local30 = (Material.PreshaderBuffer[8].yzw * Local29);
	MaterialFloat Local31 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local6), 1);
	MaterialFloat4 Local32 = Texture2DSampleBias(Material_Texture2D_3,samplerMaterial_Texture2D_3,DERIV_BASE_VALUE(Local6),View.MaterialTextureMipBias);
	MaterialFloat Local33 = MaterialStoreTexSample(Parameters, Local32, 1);
	MaterialFloat Local34 = PositiveClampedPow(Local32.b,Material.PreshaderBuffer[9].x);
	MaterialFloat Local35 = lerp(Material.PreshaderBuffer[9].w,Material.PreshaderBuffer[9].z,Local32.g);
	MaterialFloat Local36 = (Local35 * 1.00000000);
	MaterialFloat Local37 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local6), 4);
	MaterialFloat4 Local38 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_4,samplerMaterial_Texture2D_4,DERIV_BASE_VALUE(Local6),View.MaterialTextureMipBias));
	MaterialFloat Local39 = MaterialStoreTexSample(Parameters, Local38, 4);
	MaterialFloat3 Local40 = (Local38.rgb * ((MaterialFloat3)Material.PreshaderBuffer[10].x));
	MaterialFloat Local41 = PositiveClampedPow(Local32.r,Material.PreshaderBuffer[10].y);

	PixelMaterialInputs.EmissiveColor = Local20;
	PixelMaterialInputs.Opacity = 1.00000000;
	PixelMaterialInputs.OpacityMask = Local40;
	PixelMaterialInputs.BaseColor = Local30;
	PixelMaterialInputs.Metallic = Local34;
	PixelMaterialInputs.Specular = Material.PreshaderBuffer[9].y;
	PixelMaterialInputs.Roughness = Local36;
	PixelMaterialInputs.Anisotropy = 0.00000000;
	PixelMaterialInputs.Normal = MaterialFloat3(MaterialFloat2(Local14,Local15),Local12.b);
	PixelMaterialInputs.Tangent = MaterialFloat3(1.00000000,0.00000000,0.00000000);
	PixelMaterialInputs.Subsurface = 0;
	PixelMaterialInputs.AmbientOcclusion = Local41;
